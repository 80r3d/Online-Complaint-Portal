...
!function ($) {
    ...
    Dashboard.prototype.init = function () {
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Complaint', 'Request', 'Inquiry'], ['#ff5560', '#fcc24c', '#508aeb']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Complaint', 'Inquiry'], ['#508aeb', '#fcc24c']);
